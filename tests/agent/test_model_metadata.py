...
class TestCopilotAnthropicMessagesContextLength:
    """Regression tests for Copilot Claude routed through Anthropic Messages."""

    def test_prefixed_copilot_claude_sonnet_uses_anthropic_context(self):
        from agent.model_metadata import get_model_context_length
    ...
    def test_github_copilot_provider_alias_uses_anthropic_context(self):
        from agent.model_metadata import get_model_context_length
