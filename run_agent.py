...
class AIAgent:
    ...
    def _check_compression_model_feasibility(self) -> None:
        ...
        try:
            ...
            # Resolve the auxiliary provider/api mode once.  The PR needs
            # these values for context-length lookup on OpenAI-compatible
            # Claude routes; upstream also uses the provider as a best-effort
            # label for the user-facing warning below.
            try:
                (
                    aux_provider,
                    _,
                ...
                aux_provider = ""
                aux_api_mode = ""
            _aux_cfg_provider = aux_provider
